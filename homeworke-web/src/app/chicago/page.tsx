          ...
          <div className="max-w-3xl">
            ...
            <Card className="mt-8 p-6">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {neighborhoods.map((n) => (
                  <span key={n} className="rounded-full border border-[var(--hw-line)] bg-white px-3 py-2 text-xs font-medium text-[var(--hw-muted)]">
                    {n}
                  </span>
                ))}
              </div>
              <div className="mt-4 text-sm text-[var(--hw-muted)]">
                Not listed? Submit your request — we’ll confirm coverage nearby.
              </div>
            </Card>
