        ...
        <Container className="py-12">
          <div className="max-w-3xl">
            ...
            <div className="mt-6 flex items-start gap-4">
              <div className="rounded-2xl border border-[rgba(229,57,53,.18)] bg-[rgba(229,57,53,.08)] p-3">
            ...
            <Card className="mt-8 p-6">
              ...
              <div className="mt-5 rounded-2xl border border-[var(--hw-line)] bg-[var(--hw-soft)] p-4 text-sm text-[var(--hw-muted)]">
                {service.notes}
              </div>
            </Card>
