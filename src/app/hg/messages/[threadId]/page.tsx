...
export default function HomeGuideThreadPage({ params }: { params: { threadId: string } }) {
    ...
    <PortalShell role="HG" title="Home Guide" nav={HG_NAV}>
      <Container>
        <div className="flex items-start justify-between gap-4">
          ...
          <Link href="/hg/messages" className="no-underline">
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-3">
          ...
          <Card className="p-5">
            ...
            <div className="mt-3 grid gap-2">
              ...
              <div className="text-xs text-[var(--hw-muted)]">Replies are stored in the demo store for now (DB wiring next).</div>
            </div>
          </Card>
        </div>
      </Container>
