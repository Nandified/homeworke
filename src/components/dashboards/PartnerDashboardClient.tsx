...
import { Calendar, CheckCircle2, ChevronDown, ChevronUp, Clock3, Image as ImageIcon, Share2, UserPlus, Wrench } from "lucide-react";
        ...
        <div className="grid items-start gap-6 lg:grid-cols-12">
          ...
          <div className="grid gap-6 lg:col-span-12">
            ...
            <Card className="p-6 md:p-7">
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <div className="text-lg font-extrabold tracking-tight text-[var(--hw-ink)]">Marketing Tools</div>
