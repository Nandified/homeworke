      ...
      {STATUS_GROUPS.map((s, i) => {
        ...
        return (
          <div key={s} className="flex items-center">
            {i > 0 ? <div className={"mx-2 h-[2px] w-6 rounded-full " + leftLineClass} /> : null}
            ...
            {i < STATUS_GROUPS.length - 1 ? <div className={"mx-2 h-[2px] w-6 rounded-full " + rightLineClass} /> : null}
          </div>
        );
      })}
    </div>
