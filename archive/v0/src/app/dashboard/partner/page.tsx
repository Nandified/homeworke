      ...
      <Container className="py-10">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <h1 className="mt-1 text-3xl font-extrabold tracking-tight">Partner / Real Estate Pro</h1>
            <div className="mt-2 max-w-3xl text-sm leading-7 text-[var(--hw-muted)]">
              v1 scaffold. Next we’ll surface client progress, attribution, and CRM signals.
            </div>
          </div>
          <Pill>PRO</Pill>
        </div>
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 lg:grid-cols-3">
          <Card className="p-6 lg:col-span-2">
            ...
            <div className="mt-2 text-sm text-[var(--hw-muted)]">Follow Up Boss and BoldTrail placeholders.</div>
            <div className="mt-4">
          ...
          <Card className="p-6">
            ...
            <div className="mt-2 text-sm text-[var(--hw-muted)]">Schedule a demo for your office or team.</div>
            <div className="mt-4">
